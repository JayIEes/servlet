...
//2.요청방식을 처리할 수 있는 method Override
	...
	//3. 응답 방식 설정(mime type)
		...
		//5. 출력 내용 디자인
	      ...
	      out.write("\r\n");
	      out.write("<div>\r\n");
	      //HTML Form Control 입력 값 받기
	      //이름이 유일한 경우 : request.getParameter
	     // ?text=ㅇㄴ&password=fs&hid=숨김값&date=2022-04-05&file=adImg1.JPG&ta=afadf&gender=여자&domain=gmail.com&flag=on&loc=서울&age=56
	      ...
	      if(loc!=null) { //checkbox는 선택하지 않으면 Parameter로 만들어지지 않는다. - null로 들어온다.
	    	  for(String temp:loc) {
	    		  out.print(temp);
	    		  out.print(" ");
	    	  }//end for
	      ...
	      out.println("</ul>");
	      out.println("<a href='http://localhost/servlet_prj/day0428/form_parameter.jsp'>다시 입력</a>");
