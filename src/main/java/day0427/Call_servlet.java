...
//1.일반클래스로 웹 서비스를 할 수 있도록 HttpServlet을 상속받는다.
public class Call_servlet extends HttpServlet {
	
	//요청 방식을 처리 할 수 잇는 method를 Override
	//get방식 => doGet
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//3.접속자에게 제공할 응답 방식 설정  (mime-type설정)
		response.setContentType("text/html;charset=utf-8");
		
		//4. 접속자에게 출력하기 위해 접속자의 스트림을 얻는다.
		PrintWriter out =response.getWriter();
		
		//5. 스트림의 접속자에게 제공할 내용을 출력
